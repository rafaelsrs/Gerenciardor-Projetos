                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" v-model="formData.projeto.nm_projeto">
                            </div>

                            <div class="form-group mb-2">
                                <label for="name">Data Início</label>
                                <input type="date" class="form-control w-25" max="9999-12-31" v-model="formData.projeto.data_ini">
                            </div>

                             <div class="form-group mb-2">
                                <label for="name">Data Fim</label>
                                <input type="date" class="form-control w-25" max="9999-12-31" v-model="formData.projeto.data_fim">
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div v-for="(atividade, idxAtividade) in getAtividades" class="row mb-2">
...
export default {
    ...
    methods: {
        ...
        salvarprojeto() {
            ...
            let url = `${window.origin}/adicionar-projeto`;
            let method = 'POST';
        ...
        adicionarAtividade() {
            ...
            this.formData.atividades.push(modeloAtividades);
        },
        removerAtividade(idxAtividade) {
            const vm = this;
            this.formData.atividades.splice(idxAtividade, 1);
        },
    },
    computed: {
        getAtividades() {
            return this.formData.atividades;
        },
    },
};
</script>
