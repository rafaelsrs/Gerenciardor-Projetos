                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="date" class="form-control" max="9999-12-31" v-model="formData.projeto.data_ini">
                            </div>

                             <div class="form-group mb-2">
                                <label for="name">Data Fim</label>
                                <input type="date" class="form-control" max="9999-12-31" v-model="formData.projeto.data_fim">
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div v-for="(atividade, idxAtividade) in getAtividades" class="d-flex mb-2">
